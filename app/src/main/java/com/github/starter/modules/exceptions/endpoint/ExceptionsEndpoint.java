...
public class ExceptionsEndpoint {
    ...
    @GetMapping("/exceptions/null-pointer")
    public ResponseEntity<String> triggerNullPointerError() {
        String nullValue = null;
        return ResponseEntity.ok(nullValue.toString());
    }
    ...
    public ResponseEntity<String> triggerCustomStatusError(
        ...
        return ResponseEntity.status(HttpStatus.resolve(status)).body("Custom status: " + status);
    }
