...
public class SecurityConfig {
    ...
    public static class SecretsConfig {
        ...
        public void setMountPaths(List<String> mountPaths) {
            this.mountPaths = mountPaths == null ? null : List.copyOf(mountPaths);
        }
        public List<String> getEnvPrefixes() {
            return envPrefixes;
        }
        public void setEnvPrefixes(List<String> envPrefixes) {
            this.envPrefixes = envPrefixes == null ? null : List.copyOf(envPrefixes);
        }
        public Set<String> getMaskedFields() {
            return maskedFields;
        }
        public void setMaskedFields(Set<String> maskedFields) {
            this.maskedFields = maskedFields == null ? null : Set.copyOf(maskedFields);
        }
    }
    ...
    public static class CorsConfig {
        ...
        public void setAllowedOrigins(List<String> allowedOrigins) {
            this.allowedOrigins = allowedOrigins == null ? null : List.copyOf(allowedOrigins);
        }
        ...
        public void setAllowedHeaders(List<String> allowedHeaders) {
            this.allowedHeaders = allowedHeaders == null ? null : List.copyOf(allowedHeaders);
        }
        public List<String> getExposedHeaders() {
            return exposedHeaders;
        }
        public void setExposedHeaders(List<String> exposedHeaders) {
            this.exposedHeaders = exposedHeaders == null ? null : List.copyOf(exposedHeaders);
        }
